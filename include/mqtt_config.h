...
#define MQTT_RECONNECT_TIMEOUT_MS   (CONFIG_MQTT_RECONNECT_TIMEOUT*1000)

#if CONFIG_MQTT_IN_BUFFER_SIZE
#define MQTT_IN_BUFFER_SIZE_BYTE       CONFIG_MQTT_IN_BUFFER_SIZE
#else
#define MQTT_IN_BUFFER_SIZE_BYTE       1024
#endif

#if CONFIG_MQTT_OUT_BUFFER_SIZE
#define MQTT_OUT_BUFFER_SIZE_BYTE       CONFIG_MQTT_OUT_BUFFER_SIZE
#else
#define MQTT_OUT_BUFFER_SIZE_BYTE       1024
#endif
